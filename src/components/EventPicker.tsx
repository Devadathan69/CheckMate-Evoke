...
const EventPicker = () => {
  ...
  const event = getEvent('evoke-expo');
  ...
  return (
    <main className="min-h-dvh overflow-hidden bg-[#17012e] px-5 py-8 text-[#fcf9ff] sm:px-8 lg:px-12">
      ...
      <div className="mx-auto flex min-h-[calc(100dvh-4rem)] max-w-6xl flex-col">
        ...
        <section className="my-auto grid gap-10 py-14 lg:grid-cols-[1fr_1.05fr] lg:items-end">
          <div className="max-w-xl">
            ...
            <h1 className="max-w-lg font-['Syncopate'] text-3xl font-bold tracking-[-0.09em] text-[#fcf9ff] sm:text-5xl">Evoke check-in, ready to run.</h1>
            <p className="mt-5 max-w-md text-base leading-7 text-[#d8cae6]">One roster for every active participant, including the completed Venture Hackathon cohort.</p>
          ...
          <button onClick={() => navigate(`/login/${event.id}`)} className="group w-full border border-white/15 bg-[#21033f]/95 p-6 text-left shadow-[8px_8px_0_rgba(0,0,0,0.23)] transition duration-300 hover:-translate-y-1 hover:border-[#55d6c2] sm:p-8">
            ...
            <div className="mt-6 inline-flex border border-[#55d6c2]/40 bg-[#55d6c2]/10 px-3 py-2 text-sm font-semibold text-[#55d6c2]">Open organiser workspace</div>
          </button>
        </section>
      </div>
    </main>
